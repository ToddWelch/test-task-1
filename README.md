...
Fulfil supports Personal Access Tokens for server-to-server integrations and OAuth2 for user-facing apps. All API calls go to `https://{tenant}.fulfil.app/api/v2/` over HTTPS.
